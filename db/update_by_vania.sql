...
INSERT INTO public.ax_color_theme(id, name, bg_color, src_url) VALUES
(0, 'Красный', '#dc3545', 'src/img/red.jpg'), (1, 'Жёлтый', '#ffc107', 'src/img/yellow.jpg'), 
(2, 'Зелёный', '#198754', 'src/img/green.jpg'), (3, 'Синий', '#1266f1', 'src/img/blue.jpg'),
(4, 'Фиолетовый', '#6f42c1', 'src/img/purple.jpg');
