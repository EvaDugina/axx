            ...
            foreach($pages as $page_id){
              ...
              if($Page->year != $array_year || $Page->semester != $array_semester) {
                ...
                <h2 class="row" style="margin-top: 30px; margin-left: 50px;"> 
                  <?php echo getSemesterNumberByGroup($Page->year, $Page->semester, $Group->year); ?> семестр
                </h2>
                <br>
                <div class="container">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-xl-3">
                <div id="card_subject" class="card" style="border-radius: 0px 0px 10px 10px;" >
                    ...
                    // $query_tasks = select_page_tasks($Page->id, 1);
                    ...
                    //             if ($row_task_assignment['status_code'] == 2 && $row_task_assignment['status'] == 4) $count_succes_tasks++;
                    //             else if($row_task_assignment['status_code'] == 2) $count_unsucces_tasks++;
                    //         }
                    //     }
                    // }
